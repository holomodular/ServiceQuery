...
{
    public class ComparisonBetweenTestsAsyncEfc : ComparisonBetweenTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonBetweenTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
