...
{
    public class ComparisonIsNotEqualTestsAsyncEfc : ComparisonIsNotEqualTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonIsNotEqualTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
