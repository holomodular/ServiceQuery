...
{
    public class ComparisonIsInSetTestsAsyncEfc : ComparisonIsInSetTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonIsInSetTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
