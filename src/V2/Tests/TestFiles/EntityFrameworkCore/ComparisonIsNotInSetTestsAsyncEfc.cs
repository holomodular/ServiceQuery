...
{
    public class ComparisonIsNotInSetTestsAsyncEfc : ComparisonIsNotInSetTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonIsNotInSetTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
