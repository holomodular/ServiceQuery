...
{
    public class ComparisonIsNullTestsAsyncEfc : ComparisonIsNullTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonIsNullTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
