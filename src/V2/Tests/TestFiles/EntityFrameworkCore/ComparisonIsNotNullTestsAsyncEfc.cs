...
{
    public class ComparisonIsNotNullTestsAsyncEfc : ComparisonIsNotNullTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonIsNotNullTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
