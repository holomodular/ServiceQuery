...
{
    public class ComparisonIsGreaterThanOrEqualTestsAsyncEfc : ComparisonIsGreaterThanOrEqualTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonIsGreaterThanOrEqualTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
