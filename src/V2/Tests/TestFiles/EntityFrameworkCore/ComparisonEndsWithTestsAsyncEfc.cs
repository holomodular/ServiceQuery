...
{
    public class ComparisonEndsWithTestsAsyncEfc : ComparisonEndsWithTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonEndsWithTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
