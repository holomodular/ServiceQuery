...
{
    public class ComparisonStartsWithTestsAsyncEfc : ComparisonStartsWithTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonStartsWithTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
