...
{
    public class AggregateMaximumTestsAsyncEfc : AggregateMaximumTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class AggregateMaximumTestsAsyncEfc<T> : BaseTest<T> where T : class
    {
        [Fact]
