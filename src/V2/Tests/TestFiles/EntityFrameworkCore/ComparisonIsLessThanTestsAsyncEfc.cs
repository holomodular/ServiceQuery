...
{
    public class ComparisonIsLessThanTestsAsyncEfc : ComparisonIsLessThanTestsAsyncEfc<TestClass>
    {
    ...
    public abstract class ComparisonIsLessThanTestsAsyncEfc<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
