namespace ServiceQuery.Xunit
{
    public interface ITestClass
    {
        ...
        ITestClass GetDefault0Record(ITestClass testClass);

        ITestClass GetDefault1Record(ITestClass testClass);

        ITestClass GetDefault2Record(ITestClass testClass);

        ITestClass GetDefault3Record(ITestClass testClass);
