...
{
    public class ComparisonIsEqualTests : ComparisonIsEqualTests<TestClass>
    {
    ...
    public abstract class ComparisonIsEqualTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public void SyncIsEqualStandardTest()
        {
        ...
        [Fact]
        public void FoundNullIsEqualRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncNullCopyIsEqualStandardTest()
        {
        ...
        [Fact]
        public void SyncNullCopyIsEqualRequestTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
