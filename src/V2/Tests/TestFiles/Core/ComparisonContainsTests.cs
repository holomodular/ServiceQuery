...
{
    public class ComparisonContainsTests : ComparisonContainsTests<TestClass>
    {
    ...
    public abstract class ComparisonContainsTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public void SyncContainsStandardTest()
        {
        ...
        [Fact]
        public void SyncContainsRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
        ...
        [Fact]
        public void SyncNullContainsStandardTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQuery serviceQuery;
        ...
        [Fact]
        public void SyncNullContainsRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncNullCopyContainsStandardTest()
        {
        ...
        [Fact]
        public void SyncNullCopyContainsRequestTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
