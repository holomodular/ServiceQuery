...
{
    public class SortTests : SortTests<TestClass>
    {
    ...
    public abstract class SortTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        ...
        [Fact]
        public void NullCopySortAscTest()
        {
        ...
        [Fact]
        public void NullCopySortDescTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQuery serviceQuery;
        ...
        [Fact]
        public void NullCopySortDescBoolTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQuery serviceQuery;
        ...
        [Fact]
        public void NullCopySortAscRequestTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void NullCopySortDescRequestTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
