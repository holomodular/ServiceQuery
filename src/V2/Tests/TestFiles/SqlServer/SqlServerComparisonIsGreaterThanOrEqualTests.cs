namespace ServiceQuery.Xunit.Integration
{
    ...
    [Collection("SqlServer")]
    public class SqlServerComparisonIsGreaterThanOrEqualTestsAsync : ComparisonIsGreaterThanOrEqualTestsAsyncEfc<TestClass>
    {
        public SqlServerComparisonIsGreaterThanOrEqualTestsAsync()
        {
            ValidateUInt128 = false;
        }
