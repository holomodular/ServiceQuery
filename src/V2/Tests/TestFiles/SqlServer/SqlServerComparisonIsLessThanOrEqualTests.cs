namespace ServiceQuery.Xunit.Integration
{
    ...
    [Collection("SqlServer")]
    public class SqlServerComparisonIsLessThanOrEqualTestsAsync : ComparisonIsLessThanOrEqualTestsAsyncEfc<TestClass>
    {
        public SqlServerComparisonIsLessThanOrEqualTestsAsync()
        {
            ValidateUInt128 = false;
        }
