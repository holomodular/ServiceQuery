...
{
    public class ComparisonStartsWithTestsAsyncMongoDb : ComparisonStartsWithTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class ComparisonStartsWithTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public async Task SyncStartsWithStandardTest()
        {
        ...
        [Fact]
        public async Task SyncStartsWithRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullStartsWithStandardTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullStartsWithRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullCopyStartsWithStandardTest()
        {
        ...
        [Fact]
        public async Task SyncNullCopyStartsWithRequestTest()
        {
            var sourceQueryable = await GetTestNullCopyListAsync();
            if (sourceQueryable == null)
                return;
