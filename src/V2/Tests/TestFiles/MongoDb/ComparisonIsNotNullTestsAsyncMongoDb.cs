...
{
    public class ComparisonIsNotNullTestsAsyncMongoDb : ComparisonIsNotNullTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class ComparisonIsNotNullTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public async Task SyncIsNotNullStandardTest()
        {
        ...
        [Fact]
        public async Task SyncIsNotNullRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullIsNotNullStandardTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullIsNotNullRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncFoundNullIsNotNullRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullCopyIsNotNullStandardTest()
        {
        ...
        [Fact]
        public async Task SyncNullCopyIsNotNullRequestTest()
        {
            var sourceQueryable = await GetTestNullCopyListAsync();
            if (sourceQueryable == null)
                return;
