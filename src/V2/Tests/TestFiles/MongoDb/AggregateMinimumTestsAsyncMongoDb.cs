...
{
    public class AggregateMinimumTestsAsyncMongoDb : AggregateMinimumTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class AggregateMinimumTestsAsyncMongoDb<T> : BaseTest<T> where T : class
    {
        [Fact]
