...
{
    public class ComparisonIsLessThanTestsAsyncMongoDb : ComparisonIsLessThanTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class ComparisonIsLessThanTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public async Task SyncIsLessThanStandardTest()
        {
        ...
        [Fact]
        public async Task SyncIsLessThanRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullIsLessThanStandardTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullIsLessThanRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullCopyIsLessThanStandardTest()
        {
        ...
        [Fact]
        public async Task SyncNullCopyIsLessThanRequestTest()
        {
            var sourceQueryable = await GetTestNullCopyListAsync();
            if (sourceQueryable == null)
                return;
