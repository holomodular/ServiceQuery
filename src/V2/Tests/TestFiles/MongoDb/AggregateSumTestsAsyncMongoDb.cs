...
{
    public class AggregateSumTestsAsyncMongoDb : AggregateSumTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class AggregateSumTestsAsyncMongoDb<T> : BaseTest<T> where T : class
    {
