...
{
    public class ExpressionTestsAsyncMongoDb : ExpressionTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class ExpressionTestsAsyncMongoDb<T> : BaseTest<T> where T : class
    {
        [Fact]
