...
{
    public class ComparisonContainsTestsAsyncMongoDb : ComparisonContainsTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class ComparisonContainsTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
