...
{
    public class ComparisonIsNotInSetTestsAsyncMongoDb : ComparisonIsNotInSetTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class ComparisonIsNotInSetTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public async Task SyncIsNotInSetStandardTest()
        {
        ...
        [Fact]
        public async Task SyncIsNotInSetTwo()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncIsNotInSetRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncIsNotInSetTwoRequestTests()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullIsNotInSetStandardTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullIsNotInSetRequestTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullIsNotInSetRequestNoneTest()
        {
            var sourceQueryable = await GetTestListAsync();
            if (sourceQueryable == null)
                return;
        ...
        [Fact]
        public async Task SyncNullCopyIsNotInSetStandardTest()
        {
        ...
        [Fact]
        public async Task SyncNullCopyIsNotInSetRequestTest()
        {
            var sourceQueryable = await GetTestNullCopyListAsync();
            if (sourceQueryable == null)
                return;
