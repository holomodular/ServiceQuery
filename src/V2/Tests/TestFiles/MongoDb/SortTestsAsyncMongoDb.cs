...
{
    public class SortTestsAsyncMongoDb : SortTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class SortTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
