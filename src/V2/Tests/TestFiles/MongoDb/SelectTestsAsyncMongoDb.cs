...
{
    public class SelectTestsAsyncMongoDb : SelectTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class SelectTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        ...
        public async Task SelectStandardTests()
        {
            ...
            Assert.True(result.Count == 1);
            retRecord = result[0];
            oneRecord = new T().GetDefault1Record(new T());
