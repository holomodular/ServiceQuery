namespace ServiceQuery.Xunit.Integration
{
    ...
    [Collection("MongoDb")]
    public class MongoDbComparisonIsGreaterThanTestsAsync : ComparisonIsGreaterThanTestsAsyncMongoDb<MongoDbTestClass>
    {
        public MongoDbComparisonIsGreaterThanTestsAsync()
        {
            ValidateUInt128 = false;
        }
