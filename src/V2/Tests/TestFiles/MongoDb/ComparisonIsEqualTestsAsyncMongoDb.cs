...
{
    public class ComparisonIsEqualTestsAsyncMongoDb : ComparisonIsEqualTestsAsyncMongoDb<TestClass>
    {
    ...
    public abstract class ComparisonIsEqualTestsAsyncMongoDb<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
