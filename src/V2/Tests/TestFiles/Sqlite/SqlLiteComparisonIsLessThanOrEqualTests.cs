namespace ServiceQuery.Xunit.Integration
{
    ...
    [Collection("Sqlite")]
    public class SqlLiteComparisonIsLessThanOrEqualTestsAsync : ComparisonIsLessThanOrEqualTestsAsyncEfc<TestClass>
    {
        public SqlLiteComparisonIsLessThanOrEqualTestsAsync()
        {
            ValidateDateTimeOffset = false;
            ValidateTimeSpan = false;
            ValidateUInt128 = false;
