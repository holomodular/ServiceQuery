namespace ServiceQuery.Xunit
{
    ...
    {
        [Fact]
        public void SyncIsNullStandardTest()
        {
        ...
        [Fact]
        public void SyncIsNullRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
        ...
        [Fact]
        public void SyncNullIsNullStandardTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQuery serviceQuery;
        ...
        [Fact]
        public void SyncNullIsNullRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncFoundNullIsEqualRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncNullCopyIsNullStandardTest()
        {
        ...
        [Fact]
        public void SyncNullCopyIsNullRequestTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
