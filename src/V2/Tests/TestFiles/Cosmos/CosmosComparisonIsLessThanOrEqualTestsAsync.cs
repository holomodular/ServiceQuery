...
{
    [Collection("Cosmos")]
    public class CosmosComparisonIsLessThanOrEqualTestsAsync : ComparisonIsLessThanOrEqualTestsAsyncEfc<TestClass>
    {
        public CosmosComparisonIsLessThanOrEqualTestsAsync()
        {
