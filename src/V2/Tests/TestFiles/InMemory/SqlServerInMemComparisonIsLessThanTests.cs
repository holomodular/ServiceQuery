namespace ServiceQuery.Xunit
{
    ...
    [Collection("InMemory")]
    public class SqlServerInMemComparisonIsLessThanTestsAsync : ComparisonIsLessThanTestsAsyncEfc<TestClass>
    {
        public SqlServerInMemComparisonIsLessThanTestsAsync()
        {
        }
