...
namespace ServiceQuery.Xunit.Integration
{
    ...
    public class AzureDataTablesComparisonContainsTestsAsync : BaseTest
    {
        ...
        public async Task ContainsStandardTest()
        {
            ...
            //{
            //    var asyncpagableResult = _tableClient.QueryAsync<AzureDataTablesTestClass>(predicate, 1000, selectProperties);
            //});
