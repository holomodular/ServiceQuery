...
namespace ServiceQuery.Xunit.Integration
{
    ...
    public class AzureDataTablesComparisonBetweenTestsAsync : BaseTest
    {
        ...
        public async Task BetweenStandardTest()
        {
            ...
            {
                // DateTimeOffset
                var tempDateTimeOffset1 = new TestClass().GetDefault0Record(new TestClass()).DateTimeOffsetVal;
                var tempDateTimeOffset2 = new TestClass().GetDefault1Record(new TestClass()).DateTimeOffsetVal;
            ...
            // DateTime
            var tempDateTime1 = new TestClass().GetDefault0Record(new TestClass()).DateTimeVal;
            var tempDateTime2 = new TestClass().GetDefault1Record(new TestClass()).DateTimeVal;
            ...
            // Guid
            var tempg = new TestClass().GetDefault1Record(new TestClass());
