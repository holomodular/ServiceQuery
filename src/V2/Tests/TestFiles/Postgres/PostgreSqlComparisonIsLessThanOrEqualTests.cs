namespace ServiceQuery.Xunit.Integration
{
    ...
    [Collection("Postgres")]
    public class PostgreSqlComparisonIsLessThanOrEqualTestsAsync : ComparisonIsLessThanOrEqualTestsAsyncEfc<TestClass>
    {
        public PostgreSqlComparisonIsLessThanOrEqualTestsAsync()
        {
            ValidateUInt128 = false;
        }
