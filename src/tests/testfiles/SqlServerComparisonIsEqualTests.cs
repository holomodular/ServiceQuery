...
{
    public class SqlServerComparisonIsEqualTests : SqlServerComparisonIsEqualTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonIsEqualTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
