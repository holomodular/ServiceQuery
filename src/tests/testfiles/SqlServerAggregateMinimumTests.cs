...
{
    public class SqlServerAggregateMinimumTests : SqlServerAggregateMinimumTests<TestClass>
    {
    ...
    public abstract class SqlServerAggregateMinimumTests<T> : BaseTest<T> where T : class
    {
        [Fact]
