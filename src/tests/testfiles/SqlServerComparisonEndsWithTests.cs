...
{
    public class SqlServerComparisonEndsWithTests : SqlServerComparisonEndsWithTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonEndsWithTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
