...
{
    public class SqlServerComparisonContainsTests : SqlServerComparisonContainsTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonContainsTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
