...
{
    public class SqlServerComparisonIsLessThanOrEqualTests : SqlServerComparisonIsLessThanOrEqualTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonIsLessThanOrEqualTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
