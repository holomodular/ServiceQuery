...
{
    public class SqlServerComparisonIsNotEqualTests : SqlServerComparisonIsNotEqualTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonIsNotEqualTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
