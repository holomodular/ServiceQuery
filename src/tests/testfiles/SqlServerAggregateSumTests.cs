...
{
    public class SqlServerAggregateSumTests : SqlServerAggregateSumTests<TestClass>
    {
    ...
    public abstract class SqlServerAggregateSumTests<T> : BaseTest<T> where T : class
    {
