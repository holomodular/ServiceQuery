...
{
    public class SqlServerComparisonStartsWithTests : SqlServerComparisonStartsWithTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonStartsWithTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
