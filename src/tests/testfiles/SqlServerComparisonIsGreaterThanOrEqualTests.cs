...
{
    public class SqlServerComparisonIsGreaterThanOrEqualTests : SqlServerComparisonIsGreaterThanOrEqualTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonIsGreaterThanOrEqualTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
