...
{
    public class SqlServerAggregateAverageTests : SqlServerAggregateAverageTests<TestClass>
    {
    ...
    public abstract class SqlServerAggregateAverageTests<T> : BaseTest<T> where T : class
    {
