...
{
    public class SqlServerComparisonIsGreaterThanTests : SqlServerComparisonIsGreaterThanTests<TestClass>
    {
    ...
    public abstract class SqlServerComparisonIsGreaterThanTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
