...
{
    public class MongoDbTestClass : ITestClass
    {
        [BsonId]
...
#pragma warning restore CS8632 // The annotation for nullable reference types should only be used in code within a '#nullable' annotations context.
        ...
        public List<MongoDbTestClass> GetDefaultListM()
        {
            //added out of order
            return new List<MongoDbTestClass>()
            {
                GetDefault3RecordM(),
                GetDefault0RecordM(),
                GetDefault2RecordM(),
        ...
        public MongoDbTestClass GetDefault0RecordM()
        {
            return new MongoDbTestClass()
            {
                BoolVal = false,
        ...
        public MongoDbTestClass GetDefault1RecordM()
        {
            return new MongoDbTestClass()
            {
                BoolVal = true,
        ...
        public MongoDbTestClass GetDefault2RecordM()
        {
            return new MongoDbTestClass()
            {
                BoolVal = false,
        ...
        public MongoDbTestClass GetDefault3RecordM()
        {
            return new MongoDbTestClass()
            {
                BoolVal = true,
        ...
        ITestClass ITestClass.GetDefault0Record()
        {
            return GetDefault0RecordM();
        }

        ITestClass ITestClass.GetDefault1Record()
        {
            return GetDefault1RecordM();
        }

        ITestClass ITestClass.GetDefault2Record()
        {
            return GetDefault2RecordM();
        }

        ITestClass ITestClass.GetDefault3Record()
        {
            return GetDefault3RecordM();
        }
        ...
        public virtual List<TestClass> GetDefaultList()
        {
            ...
            {
                (TestClass)testClass.GetDefault3Record(),
                (TestClass)testClass.GetDefault0Record(),
                (TestClass)testClass.GetDefault2Record(),
                (TestClass)testClass.GetDefault1Record(),
            };
        }
    }
}