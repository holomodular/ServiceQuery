...
{
    public class LinqAsyncComparisonBetweenTests : LinqAsyncComparisonBetweenTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonBetweenTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
