...
{
    public class LinqAsyncComparisonIsNotInSetTests : LinqAsyncComparisonIsNotInSetTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonIsNotInSetTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
