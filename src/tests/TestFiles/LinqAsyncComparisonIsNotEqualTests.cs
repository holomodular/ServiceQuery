...
{
    public class LinqAsyncComparisonIsNotEqualTests : LinqAsyncComparisonIsNotEqualTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonIsNotEqualTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
