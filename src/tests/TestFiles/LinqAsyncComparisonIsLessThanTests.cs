...
{
    public class LinqAsyncComparisonIsLessThanTests : LinqAsyncComparisonIsLessThanTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonIsLessThanTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
