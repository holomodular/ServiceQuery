...
{
    public class LinqAsyncComparisonIsNotNullTests : LinqAsyncComparisonIsNotNullTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonIsNotNullTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
