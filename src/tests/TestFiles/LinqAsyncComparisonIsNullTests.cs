...
{
    public class LinqAsyncComparisonIsNullTests : LinqAsyncComparisonIsNullTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonIsNullTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
