...
{
    public class LinqAsyncComparisonIsGreaterThanTests : LinqAsyncComparisonIsGreaterThanTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonIsGreaterThanTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
