...
{
    public class LinqAsyncComparisonStartsWithTests : LinqAsyncComparisonStartsWithTests<TestClass>
    {
    ...
    public abstract class LinqAsyncComparisonStartsWithTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
