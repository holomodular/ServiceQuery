...
{
    public class LinqAsyncAggregateAverageTests : LinqAsyncAggregateAverageTests<TestClass>
    {
    ...
    public abstract class LinqAsyncAggregateAverageTests<T> : BaseTest<T> where T : class
    {
