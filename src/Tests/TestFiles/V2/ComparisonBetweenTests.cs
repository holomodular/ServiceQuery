...
{
    public class ComparisonBetweenTests : ComparisonBetweenTests<TestClass>
    {
    ...
    public abstract class ComparisonBetweenTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public void SyncBetweenStandardTest()
        {
            ...
            // DateOnly
            var tempDateOnly1 = new T().GetDefault0Record().DateOnlyVal;
            var tempDateOnly2 = new T().GetDefault1Record().DateOnlyVal;
...
#if NET6_0_OR_GREATER
            // TimeOnly
            var tempTimeOnly1 = new T().GetDefault0Record().TimeOnlyVal;
            var tempTimeOnly2 = new T().GetDefault1Record().TimeOnlyVal;
        ...
        [Fact]
        public void SyncBetweenRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
        ...
        [Fact]
        public void SyncNullBetweenStandardTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQuery serviceQuery;
        ...
        [Fact]
        public void SyncNullBetweenRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncNullCopyBetweenStandardTest()
        {
        ...
        [Fact]
        public void SyncNullCopyBetweenRequestTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
