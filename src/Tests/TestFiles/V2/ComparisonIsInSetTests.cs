...
{
    public class ComparisonIsInSetTests : ComparisonIsInSetTests<TestClass>
    {
    ...
    public abstract class ComparisonIsInSetTests<T> : BaseTest<T> where T : class, ITestClass, new()
    {
        [Fact]
        public void SyncIsInSetStandardTest()
        {
...
#if NET6_0_OR_GREATER
            // DateOnly
            var tempDateOnly1 = new T().GetDefault1Record().DateOnlyVal;
            var tempDateOnly2 = new T().GetDefault2Record().DateOnlyVal;
...
#if NET6_0_OR_GREATER
            // TimeOnly
            var tempTimeOnly1 = new T().GetDefault1Record().TimeOnlyVal;
            var tempTimeOnly2 = new T().GetDefault2Record().TimeOnlyVal;
        ...
        [Fact]
        public void SyncIsInSetRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
        ...
        [Fact]
        public void SyncIsInSetTwoRequest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncNullIsInSetStandardTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQuery serviceQuery;
        ...
        [Fact]
        public void SyncNullIsInSetRequestTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncNullIsInSetRequestAllTest()
        {
            var sourceQueryable = GetTestList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
        ...
        [Fact]
        public void SyncNullCopyIsInSetStandardTest()
        {
        ...
        [Fact]
        public void SyncNullCopyIsInSetRequestTest()
        {
            var sourceQueryable = GetTestNullCopyList();
            IQueryable<T> testQueryable;
            IServiceQueryRequest serviceQuery;
