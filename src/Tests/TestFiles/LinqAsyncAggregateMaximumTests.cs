...
{
    public class LinqAsyncAggregateMaximumTests : LinqAsyncAggregateMaximumTests<TestClass>
    {
    ...
    public abstract class LinqAsyncAggregateMaximumTests<T> : BaseTest<T> where T : class
    {
        [Fact]
