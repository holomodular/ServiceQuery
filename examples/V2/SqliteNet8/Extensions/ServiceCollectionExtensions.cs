...
namespace WebApp.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddCustomWebsite(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            services.Configure<DbContextOptions<SqliteDatabaseContext>>(o => { o = builder.Options; });
            services.AddSingleton<DbContextOptions<SqliteDatabaseContext>>(builder.Options);
            services.AddDbContext<SqliteDatabaseContext>(c => { c = builder; }, ServiceLifetime.Scoped);
