...
namespace WebApp.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddCustomWebsite(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            services.Configure<DbContextOptions<SqlServerDatabaseContext>>(o => { o = builder.Options; });
            services.AddSingleton<DbContextOptions<SqlServerDatabaseContext>>(builder.Options);
            services.AddDbContext<SqlServerDatabaseContext>(c => { c = builder; }, ServiceLifetime.Scoped);
