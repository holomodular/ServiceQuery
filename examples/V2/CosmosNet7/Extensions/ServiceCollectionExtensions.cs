...
namespace WebApp.Extensions
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddCustomWebsite(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            // Register Database Cosmos
            var builder = new DbContextOptionsBuilder<CosmosDatabaseContext>();
            builder.UseCosmos(Configuration.GetConnectionString("CosmosConnectionString"), Configuration.GetConnectionString("CosmosDatabase"));
            services.Configure<DbContextOptions<CosmosDatabaseContext>>(o => { o = builder.Options; });
            services.AddSingleton<DbContextOptions<CosmosDatabaseContext>>(builder.Options);
            services.AddDbContext<CosmosDatabaseContext>(c => { c = builder; }, ServiceLifetime.Scoped);
