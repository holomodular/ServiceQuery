...
namespace WebApp.Controllers.api.v1
{
    ...
    public class EntityFrameworkCoreSqliteController : ExampleController
    {
        private readonly SqliteDatabaseContext _context;

        public EntityFrameworkCoreSqliteController(
            SqliteDatabaseContext exampleDatabaseContext,
